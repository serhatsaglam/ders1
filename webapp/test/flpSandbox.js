		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#malzemeanaverisi-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"malzemeanaverisi-display": {
								"semanticObject": "malzemeanaverisi",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.kartonsan.ders1",
									"url": sap.ui.require.toUrl("com/kartonsan/ders1")
								}
							}
						}
					}
